...
export const OC_FALTAS_GROUPS = [
  {
    ...
    items: [
      'Forzar rol agresivo.',
      'Meterse en rol ajeno.',
      'No usar el /entorno en actos delictivos.',
      'Excederse en los robos y secuestros.',
      ...
      'Abuso de animación.',
      'Falta IDP en vehículos (deben ser del color de la orga).',
      'Vestirse de paisano en roles agresivos (falta IDP).',
      'Ignorar comunicados de la staff.',
      'No respetar entorno en zonas seguras (sacar/guardar armas de coches o similar).',
    ]
  },
  {
    ...
    items: [
      ...
      'Forzar rol con LSPD en norte (controles de carretera, patrullajes…).',
      'Campear zona roja o sedes.',
      'Disparar desde dentro de zona roja hacia fuera y viceversa.',
      'Farmear en puntos privados que no sean de tu orga.',
    ]
  },
  {
    ...
    items: [
      ...
      'Alianzas con otras organizaciones criminales para roles agresivos.',
      'Cachear en zona segura.',
      'Robar armamento policial — conlleva además BAN permanente.',
      'Realizar mutilaciones o roles +18 no consentidos.',
      'Faltar el respeto al equipo de staff.',
      'Ignorar órdenes del staff.',
      'Propagar toxicidad sobre el servidor y el staff — Ban permanente.',
      'Llevar armas no permitidas por nivel dentro de ciudad.',
      'Mensajes de odio a otros usuarios.',
      'Entrar a sede ajena sin intención de negociar.',
    ]
  }
];

export const OC_SANCIONES_TABLE = [
  // [descripción, sanción] — tiempos según normativa oficial (docx)
  ['Forzar rol agresivo',                                        'Jail 40 min'],
  ['Meterse en rol ajeno',                                       'Jail 50 min'],
  ['No usar /entorno en actos delictivos',                       'Jail 30 min'],
  ['Excederse en robos y secuestros',                            'Jail 30 min'],
  ['Incumplimiento de la normativa del servidor',                'Jail 50 min'],
  ['Iniciar roles agresivos sin motivo',                         'Jail 50 min'],
  ['PG en rol con LSPD',                                         'Jail 40 min'],
  ['No respetar el rol de entorno',                              'Jail 40 min'],
  ['Dejar con bridas puestas a un usuario por diversión',        'Jail 50 min'],
  ['Iniciar tiroteo con la policía sin rol previo',              'Jail 50 min'],
  ['Tirar de F8 en mitad de un rol/tiroteo',                     'Jail 180 min'],
  ['No valorar la vida',                                         'Jail 40 min'],
  ['Falta de FairPlay',                                          'Jail 40 min'],
  ['Abuso de animación',                                         'Jail 20 min'],
  ['Falta IDP en vehículos (deben ser del color de la orga)',    'Jail 20 min'],
  ['Vestirse de paisano en roles agresivos (falta IDP)',         'Jail 20 min'],
  ['Matar encima de vehículos sin reposicionamiento',            'Jail 50 min'],
  ['No respetar rol de entorno de sedes y barrios',              'Jail 60 min'],
  ['No respetar entorno en zonas seguras (armas/coches)',        'Jail 30 min'],
  ['Alianzas con otras OC para roles agresivos',                 'Jail 60 min'],
  ['Cachear en zona segura',                                     'Jail 60 min'],
  ['Robar armamento policial siendo de orga',                    'Jail 60 min'],
  ['Uso de programas externos para MG',                          'Jail 50 min'],
  ['Mutilaciones o roles +18 no consentidos',                    'Jail 60 min'],
  ['Faltar el respeto al equipo de staff',                       'Lo valorará el staff'],
  ['Ignorar comunicados de la staff',                            'Jail 30 min'],
  ['Ignorar órdenes del staff',                                  'Lo valorará el staff'],
  ['Propagar toxicidad sobre el servidor y la staff',            'Ban permanente'],
  ['Llevar armas no permitidas por nivel dentro de ciudad',      'Jail 60 min'],
  ['Mensajes de odio a otros usuarios',                          'Jail 60 min'],
  ['Entrar a sede ajena sin intención de negociar',              'Jail 60 min'],
  ['Campear zona roja/sedes',                                    'Jail 50 min'],
  ['Disparar desde dentro de zona roja hacia fuera y viceversa', 'Jail 60 min'],
  ['Forzar rol con LSPD en norte (controles, patrullajes…)',     'Jail 50 min'],
  ['Farmear en puntos privados que no sean de tu orga',          'Jail 90 min'],
  ['Uso de cheats',                                              'Ban permanente'],
];

export const ZONA_DOMINACION = [
  { type: 'x',    text: 'Prohibido acceder con vehículos — dejarlos fuera del círculo rojo.' },
  { type: 'x',    text: 'Respetar los límites de la zona: prohibido disparar de fuera hacia adentro y viceversa.' },
  { type: 'ok',   text: 'Está permitido cachear una vez abatido el sujeto — no es necesario esperar a que termine el tiroteo.' },
  { type: 'x',    text: 'Prohibido campear la zona o dar vueltas por los alrededores para sacar información.' },
  { type: 'x',    text: 'No puedes entrar sin armamento (pistola, radio, munición…).' },
  { type: 'info', text: 'Todos los miembros deben entrar con ropa de orga y enmascarados.' },
  { type: 'info', text: 'Los miembros de la misma organización deben entrar juntos — prohibido acudir en oleadas.' },
  { type: 'x',    text: 'No está permitido volver a la dominación una vez hayas sido abatido.' },
  { type: 'ok',   text: 'No es necesario pertenecer a una organización para entrar en la zona de dominación.' },
  { type: 'x',    text: 'Prohibido esconderse o campear en arbustos.' },
  { type: 'ok',   text: 'Está permitido iniciar rol agresivo una vez acaba la dominación, siempre iniciándolo desde dentro de la zona roja.' },
];
