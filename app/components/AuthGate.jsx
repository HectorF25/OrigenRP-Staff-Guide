...
export default function AuthGate({ error }) {
  return (
    <div className="gate" id="authGate">
      <div className="gate-card">
        ...
        <div className="gate-sub">
          Inicia sesión con Discord para acceder al panel.<br />
          Solo cuentas con rol de staff en el servidor pueden entrar.
        </div>
        {error && <div className="gate-err">{error}</div>}
        <a className="gate-btn" href="/api/auth/login">
        ...
        <div className="gate-foot">© OrigenRP · Panel interno de staff</div>
      </div>
    </div>
  );
}
